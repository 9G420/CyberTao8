...
v0.1.116 已完成“敌方意图连线首版”：战斗流程可实时生成敌方下一步攻击/移动意图，2D 棋盘显示 `ATK/MOV` 连线与目标圈，便于玩家预判并打断。
...
1. 执行 `A2_path_loop_resonance`：先做“闭环即加成”的最小可玩规则，并在 2D 视图给出触发反馈。

...
| 毒素注入 | 1E | 施加毒素3回合（2伤/回合） | 毒素注入+ → 4回合 |
| 能量虹吸 | 0E | 额外抽2张牌 | 能量虹吸+ → 抽3张 |
| 反击 | 1E | 防御+2，蓄力反击3伤害 | 反击+ → 防御+3，反击4 |

...
CardBattleController（卡牌层独立状态机）         ~423行
...
| 任务 | 说明 |
|------|------|
| **BattleFlowController 瘦身** | 剥离 debug spawn 系列函数到 DebugScenario.gd |
| **能量成长机制** | 随游戏进度每回合能量上限+1 |
| **Boss 遭遇** | 特殊遭遇格触发 Boss 战（HP高+独特模式） |

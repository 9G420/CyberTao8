...
func _build_ui() -> void:
	...
	phase_label.position = Vector2(20, 60)
	...
	roll_button.position = Vector2(20, 96)
	...
	path_button.position = Vector2(20, 146)
	...
	roll_label.position = Vector2(20, 202)
	...
	crest_label.position = Vector2(20, 258)
	crest_label.size = Vector2(240, 102)
